...
class FeatureExtractor(nn.Module):
  def __init__(self):
    ...
    self._block4_conv4 = nn.Conv2d(in_channels = 512, out_channels = 512, kernel_size = (3, 3), stride = 1, padding = "same")
    ...
    self._block5_conv4 = nn.Conv2d(in_channels = 512, out_channels = 512, kernel_size = (3, 3), stride = 1, padding = "same")
