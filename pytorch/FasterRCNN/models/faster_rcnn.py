...
class FasterRCNNModel(nn.Module):
  ...
  def __init__(self, num_classes, rpn_minibatch_size = 256, proposal_batch_size = 128, allow_edge_proposals = True, dropout_probability = 0, backbone = 'vgg16'):
    super().__init__()
    ...
    self._stage1_feature_extractor = Backbone(backbone).FeatureExtractor()
