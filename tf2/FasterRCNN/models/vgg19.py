...
# tf2/FasterRCNN/models/vgg19.py
# Copyright 2021-2022 Bart Trzynadlowski
#
# TensorFlow/Keras implementation of the VGG-19 backbone for use as a feature
...
class FeatureExtractor(tf.keras.Model):
  def __init__(self, l2 = 0):
    ...
    self._block4_conv4 = Conv2D(name = "block4_conv4", kernel_size = (3,3), strides = 1, filters = 512, padding = "same", activation = "relu", kernel_initializer = initial_weights, kernel_regularizer = regularizer)
    ...
    self._block5_conv4 = Conv2D(name = "block5_conv4", kernel_size = (3,3), strides = 1, filters = 512, padding = "same", activation = "relu", kernel_initializer = initial_weights, kernel_regularizer = regularizer)
